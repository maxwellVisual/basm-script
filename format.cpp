...
//     // std::basic_stringbuf<_CharT> obuf;
//     // std::basic_stringbuf<_CharT> ibuf;
...
//         }
//     }
//     inline void put(const _CharT& c){
//         obuf.push(c);
//     }
...
//     return std::make_shared<num>(nullptr, (long double)out);
// }
// inline std::shared_ptr<value> call_print(std::shared_ptr<value> &msg_val, std::wostream& wout){
//     escape_stream<wchar_t> s;
//     std::shared_ptr<obj> msg_obj = std::dynamic_pointer_cast<obj>(msg_val);
